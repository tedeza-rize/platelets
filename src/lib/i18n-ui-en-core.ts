export const enUiCore = {
  ...
  "login.securityNote": "Only approved staff can access this console.",
  "map.performance.lowFps":
    "Map rendering is slow on this device. Reduce visible categories or switch to 2D view.",
  "map.popup.addressFound": "Address found",
  "map.popup.addressLoading": "Finding address",
  "map.popup.addressUnavailable":
    "Address API is not connected, so only coordinates are shown.",
  "map.popup.coordinates": "Coordinates",
  "map.popup.selectedLocation": "Selected location",
  "map.popup.selectedPoint": "Selected point",
  "map.status.recentEvents": "Recent events",
  "map.status.viewportLoaded": "Showing data for the current map view.",
  ...
  "dashboard.sheet.emergencyRoom": "Emergency room open",
  "dashboard.sheet.fireStation": "Fire station",
  "dashboard.sheet.hospital": "Medical facility",
  "dashboard.sheet.phone": "Phone",
  "dashboard.sheet.selectedLocation": "Selected location",
